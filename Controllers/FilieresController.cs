...
namespace pfe.Controllers
{
    public class FilieresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("idFiliere,nomFiliere")] Filiere filiere)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("idFiliere,nomFiliere")] Filiere filiere)
        {
